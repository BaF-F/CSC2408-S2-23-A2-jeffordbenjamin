...
If you had already added the previous version of the archive,
which contained some errors, simply re-add and commit the new
files in your repository. Files that aren't used but were already
tracked can be deleted with "git rm filename".  
